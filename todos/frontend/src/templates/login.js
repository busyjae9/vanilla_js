        ...
        <div class="login">
            ...
            <form action="" class="login__rows">
                <div class="login__row">
                    ...
                    <input type="text" class="login__row__value" name="email" placeholder="이메일을 입력해주세요.">
                </div>
                <div class="login__row">
                    <div class="login__row__key">비밀번호</div>
                    <input type="password" class="login__row__value" name="password" placeholder="비밀번호를 입력해주세요.">
                </div>
        ...
        <div class="reg">
            ...
            <form action="" class="reg__rows">
                <div class="reg__row">
                    ...
                    <input type="text" class="reg__row__value" name="name" placeholder="이름을 입력해주세요.">
                </div>
                <div class="reg__row">
                    <div class="reg__row__key">이메일</div>
                    <input type="text" class="reg__row__value" name="email" placeholder="이메일을 입력해주세요.">
                </div>
                <div class="reg__row">
                    <div class="reg__row__key">비밀번호</div>
                    <input type="password" class="reg__row__value" name="password" placeholder="비밀번호를 입력해주세요.">
                </div>
                <div class="reg__row">
                    <div class="reg__row__text">
                        대충 개인정보 및 합법적인 약관에 관한 내용으로 정재훈에게 TODO를 마음대로 열람할 수 있는 권한을 부여한다는 내용이 추가되어 있는 약관
                    </div>
                </div>
                <div class="reg__row">
